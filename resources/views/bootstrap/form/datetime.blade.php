<div class="form-group">
    ...
    <div class="input-group">
    	<input type="date" name="{{ $name }}__date" id="{{ $name }}__date" value="{{ old($name . '__date', $initial ? $initial->format('Y-m-d') : '') }}"
    	...
    	>
    	<input type="time" name="{{ $name }}__time" id="{{ $name }}__time" value="{{ old($name . '__time', $initial ? $initial->format('H:i') : '') }}"
